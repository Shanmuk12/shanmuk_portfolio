...
exports.createEmotionSsrAdvancedApproach = void 0;
...
CacheProvider = react_1.CacheProvider) {
    ...
    function augmentDocumentWithEmotionCache(Document) {
        ...
        Document.getInitialProps = (documentContext) => __awaiter(this, void 0, void 0, function* () {
            ...
            const emotionServer = (0, create_instance_1.default)(cache);
            ...
            (0, assert_1.assert)(super_getInitialProps !== undefined, "If you get this error please open an issue on the tss-react repo");
            ...
            const emotionStyles = [
                ...
                ...emotionServer
                    ...
                    .map(style => (React.createElement("style", { "data-emotion": `${style.key} ${style.ids.join(" ")}`, key: style.key, dangerouslySetInnerHTML: { "__html": style.css } })))
            ];
